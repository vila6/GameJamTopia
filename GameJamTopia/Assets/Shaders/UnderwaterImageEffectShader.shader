Shader "Custom/UnderwaterImageEffectShader"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float _NoiseFrecuency, _NoiseScale, _NoiseSpeed, _PixelOffset, _DepthDistance, _DepthStart;
            ...
            fixed4 frag (v2f i) : COLOR
            {
                ...
                float3 spos = float3(i.scrPos.x, i.scrPos.y, 0) * _NoiseFrecuency;     
